        ...
        <div className={"home-container"}>
            <div className={"home-header"}>
                <div className={"home-logo"}>
                    <a href="/dashboard">
                        <img width={100} src={"../images/"} alt="Logo"/>
                    </a>
                </div>
                ...
                <div className={"home-btn-wrapper"}>
                    ...
                    <Link to={"/wishlist"}>
                        <button><i className="fa-regular fa-heart"></i>My Wishlist</button>
                    </Link>
                    <Link to="/Login">
                        <button>Login</button>
                    </Link>
                        ...
                        <Carousel>
                            <Carousel.Item interval={2000}>
                                <img
                                    ...
                                    src="images/pexels-anna-pou-8329274.jpg"
                                    alt="First slide"
                                />
                            </Carousel.Item>
                            <Carousel.Item interval={2000}>
                                <img
                                    className="d-block w-100"
                                    src="images/pexels-cottonbro-studio-6739702.jpg"
                                    alt="Second slide"
                                />
                            </Carousel.Item>
                            <Carousel.Item interval={2000}>
                                <img
                                    className="d-block w-100"
                                    src="images/pexels-cottonbro-studio-6739236.jpg"
                                    alt="Third slide"
                                />
                            </Carousel.Item>
                        </Carousel>
                    ...
                    <div className={"home-img-dash2"}>
                        <Carousel fade>
                            <Carousel.Item interval={1000}>
                                <img
                                    className="d-block w-100"
                                    src="images/pexels-kristina-paukshtite-2417857.jpg"
                                    alt="First slide"
                                />
                            ...
                            <Carousel.Item interval={1000}>
                                <img
                                    className="d-block w-100"
                                    src="images/pexels-yagnesh-patel-7893331.jpg"
                                    alt="Second slide"
                                />
                            ...
                            <Carousel.Item interval={1000}>
                                <img
                                    className="d-block w-100"
                                    src="images/pexels-efnan-yılmaz-17779242.jpg"
                                    alt="Third slide"
                                />
                            </Carousel.Item>
                        </Carousel>
