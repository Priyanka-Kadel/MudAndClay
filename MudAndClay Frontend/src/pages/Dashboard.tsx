                        ...
                        <Carousel>
                            <Carousel.Item interval={2000}>
                                <img
                                    ...
                                    src="images/pexels-japneet-singh-15810418.jpg"
                                    alt="First slide"
                                />
                            </Carousel.Item>
                            <Carousel.Item interval={2000}>
                                <img
                                    className="d-block w-100"
                                    src="images/Nike%20Mercurial%20Superfly%207%20Elite%20FG%20-%20Desert%20Sand-Purple%2011.jpg"
                                    alt="Second slide"
                                />
                            </Carousel.Item>
                            <Carousel.Item interval={2000}>
                                <img
                                    className="d-block w-100"
                                    src="images/pexels-kevin-mccartney-774321.jpg"
                                    alt="Third slide"
                                />
                            </Carousel.Item>
                        </Carousel>
                    ...
                    <div className={"db-img-dash2"}>
                        <Carousel fade>
                            <Carousel.Item interval={1000}>
                                <img
                                    className="d-block w-100"
                                    src="images/pexels-kampus-production-8941651.jpg"
                                    alt="First slide"
                                />
                            ...
                            <Carousel.Item interval={1000}>
                                <img
                                    className="d-block w-100"
                                    src="images/pexels-rfstudio-3621104.jpg"
                                    alt="Second slide"
                                />
